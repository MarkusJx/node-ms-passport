...
Napi::Number passportAccountExists(const Napi::CallbackInfo& info) {
	CHECK_ARGS(STRING);

	try {
		int res = passport::passportAccountExists(info[0].ToString().Utf8Value());
...
Napi::Object InitAll(Napi::Env env, Napi::Object exports) {
	...
	exports.Set(EXPORT(passportAccountExists));
